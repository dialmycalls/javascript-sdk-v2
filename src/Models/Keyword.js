...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DialmycallsJsClient.Keyword = factory(root.DialmycallsJsClient.ApiClient);
  }
   ...
   * @module Models/Keyword
   * @version 2.0.1
   */

  /**
   * Constructs a new <code>Keyword</code>.
   * @alias module:Models/Keyword
   * @class
   */
   ...
   * @param {module:Models/Keyword} obj Optional instance to populate.
   * @return {module:Models/Keyword} The populated <code>Keyword</code> instance.
   */
