...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DialmycallsJsClient.Callerid = factory(root.DialmycallsJsClient.ApiClient);
  }
   ...
   * @module Models/Callerid
   * @version 2.0.1
   */

  /**
   * Constructs a new <code>Callerid</code>.
   * @alias module:Models/Callerid
   * @class
   */
   ...
   * @param {module:Models/Callerid} obj Optional instance to populate.
   * @return {module:Models/Callerid} The populated <code>Callerid</code> instance.
   */
