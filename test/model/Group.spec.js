...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DialmycallsJsClient.Group();
  });
  ...
  describe('Group', function() {
    it('should create an instance of Group', function() {
      ...
      //var instane = new DialmycallsJsClient.Group();
      //expect(instance).to.be.a(DialmycallsJsClient.Group);
    });
    ...
    it('should have the property contactsCount (base name: "contacts_count")', function() {
