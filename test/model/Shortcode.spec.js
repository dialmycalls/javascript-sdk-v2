...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DialmycallsJsClient.Shortcode();
  });
  ...
  describe('Shortcode', function() {
    it('should create an instance of Shortcode', function() {
      // uncomment below and update the code to test Shortcode
      //var instane = new DialmycallsJsClient.Shortcode();
      //expect(instance).to.be.a(DialmycallsJsClient.Shortcode);
    });
