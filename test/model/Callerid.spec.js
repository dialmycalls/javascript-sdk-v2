...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DialmycallsJsClient.Callerid();
  });
  ...
  describe('Callerid', function() {
    it('should create an instance of Callerid', function() {
      // uncomment below and update the code to test Callerid
      //var instane = new DialmycallsJsClient.Callerid();
      //expect(instance).to.be.a(DialmycallsJsClient.Callerid);
    });
