...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DialmycallsJsClient.Groups();
  });
  ...
  describe('Groups', function() {
    describe('createGroup', function() {
      it('should call createGroup successfully', function(done) {
        ...
        //instance.createGroup(pet, function(error) {
    ...
    describe('deleteGroupById', function() {
      it('should call deleteGroupById successfully', function(done) {
        ...
        //instance.deleteGroupById(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getGroupById', function() {
      it('should call getGroupById successfully', function(done) {
        ...
        //instance.getGroupById(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('updateGroupById', function() {
      it('should call updateGroupById successfully', function(done) {
        ...
        //instance.updateGroupById(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
